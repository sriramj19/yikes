...
app.controller('ChatController',['$http', '$scope', '$localStorage', 'ChatService', function($http, $scope, $localStorage, ChatService){
  ...
  $scope.setCurrentChatRoom = function(currentChatRoom) {
    var flag = false;
    _.forEach($localStorage.userDetails.subscriptions, function(value) {
